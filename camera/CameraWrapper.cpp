...
static int camera_open_legacy(const struct hw_module_t* module, const char* id, uint32_t halVersion,
...
camera_module_t HAL_MODULE_INFO_SYM = {
    .common = {
        ...
        .name = "Sony Xperia Camera Wrapper",
...
static int camera_device_open(const hw_module_t* module, const char* name, hw_device_t** device) {
    ...
    ALOGV("%s: property persist.vendor.camera.HAL3.enabled is set to %d", __FUNCTION__,
          isHAL3Enabled);
